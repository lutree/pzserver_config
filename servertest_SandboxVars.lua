SandboxVars = {
    ...
    BecomeDesensitized = {
        -- 최소 =1 최대 =10000 기본 =500
        MinimumZombieKills = 500,
        -- 최소 =1 최대 =10000 기본 =2000
    ...
    MoreTraits = {
        ...
        -- 최소 =1 최대 =240 기본 =60
        BouncerCooldown = 60,
        -- 최소 =0.25 최대 =5.00 기본 =1.75
        BouncerDistance = 1.75,
        -- 최소 =100 최대 =1000 기본 =200
        GymGoerPercent = 200,
        ...
        -- 최소 =25 최대 =1000 기본 =100
        MartialScaling = 100,
        -- 최소 =0 최대 =100 기본 =33
        EvasiveChance = 33,
        EvasiveAnimation = true,
        -- 최소 =100 최대 =10000 기본 =2000
